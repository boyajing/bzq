     ...
     $.fn.serializeObject = function() {  
        ...
        $("#edit").click(function() {
            ...
            $.ajax({  
                ...
                url : '<%=cpath%>/jeda/role/edit?r=<c:out value="${returnview}"/>',  
                data : jsonrole,  
                dataType : 'json',  
                success : function() {  
                    alert("角色修改成功。");
                    location.href="<%=cpath%>/jeda/role/view?r=${returnview}&roleId="+role.roleId;//
                } ,
                error:function(){
                    alert("修改失败");
                    }
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane active in" id="home">
                            <form id="tab">
                                ...
                                <label>角色名</label>
                                <input type="text" name="roleName" value="${role.roleName}" class="input-xlarge">                                
                                <label>角色描述</label>
                                <input type="text"  name="roleDescription" value="${role.roleDescription}" class="input-xlarge">  
                            </form>
                        </div>
                    </div>
                </div>
