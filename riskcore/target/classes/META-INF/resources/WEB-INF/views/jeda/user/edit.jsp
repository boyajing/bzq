     ...
     $.fn.serializeObject = function() {  
        ...
        $("#edit").click(function() {
            ...
            $.ajax({  
                ...
                url : '<%=cpath%>/jeda/user/edit',  
                data : jsonuser,  
                dataType : 'json',  
                success : function() {  
                    alert("用户修改成功。");
                    location.href="<%=cpath%>/jeda/user/view?r=${returnview}&userId="+user.userId;//
                } ,
                error:function(user){
                    alert("修改失败");
                    }
                            ...
                            <form id="tab">
                                <table class="well table resultTable table-hover"> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="userGender" name="userGender" >
                                                ...
                                                <c:if test="${user.userGender=='F'}">
                                                    <option value="F" checked="true">女</option>
                                        ...
                                        <td>Email</td>
                                        <td>
                                            <input type="text"  name="userEmail" value="${user.userEmail}"  valType="MAIL"  msg="<font color=red>*</font>请输入正确格式" class="input-xlarge">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>职务</td>
                                    ...
                                    <tr>
                                        <td>电话</td>
                                        <td>
                                            <input type="text" name="userTel" value="${user.userTel}" valType="TEL" msg="<font color=red>*</font>请输入正确格式" class="input-xlarge">
                                        </td>
                                        <td>手机</td>
                                        <td>
                                            <input type="text" name="userMobile" value="${user.userMobile}"  valType="MOBILE" msg="<font color=red>*</font>请输入正确格式"  class="input-xlarge">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>地址</td>
