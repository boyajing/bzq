...
<html>
    ...
    <script language="javascript">
        ...
        function orgtreeClick(id){
            window.open('<%=cpath%>/jeda/user/selectuser?org='+id,"rightframe");
        }
        function updateNavByMenuid(id,items){
            parent.updateNavByMenuid(id,items);
        }
...
<frameset id='mainframe' cols="200px,*">
  ...
  <frame name='rightframe' src="<%=cpath%>/jeda/user/selectuser" />
</frameset>
