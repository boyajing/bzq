...
<html>
    ...
    <script language="javascript">
        ...
        function menutreeClick(id){
            window.open('<%=cpath%>/jeda/menu/query?pmenu='+id,"rightframe");
        }
    </script>
    </head>
    <frameset id='mainframe' cols="200px,*">
  <frame name='leftframe' src="<%=cpath%>/jeda/menu/menutree" />
  <frame name='rightframe' src="<%=cpath%>/jeda/menu/query" />
</frameset>
</html>
