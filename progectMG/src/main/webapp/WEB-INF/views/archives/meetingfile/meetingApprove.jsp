...
<script type="text/javascript">
    ...
    function queryAll(temp) {
        ...
        window.open("<%=path%>/fileManager/index_view?businessType=file_7&businessId="+temp, "会议审议档案管理", "height=800,width=1500,top=100,left=300,toolbar=no,menubar=no,scrollbars=yes, resizable=1,location=no, status=no");
    }
</script>