...
<script type="text/javascript">
    ...
    function uploading() {
        ...
        window.open("<%=path%>/fileManager/upfiletype?businessType=${tArchives.businessType}&businessId=${tArchives.businessId}&projectCode=${tArchives.projectCode}&childType=${tArchives.childType}",
