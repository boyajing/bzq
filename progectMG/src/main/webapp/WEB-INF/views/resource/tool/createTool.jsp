...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/js/toolverify/verifytool.js"></script>
        ...
        <form id="expendForm" method="post">
            ...
            <table id="atable">
                ...
                <tr>
                    <td>工具编号</td>
                    <td>
                        <input readonly type="text" value="${tool.toolNo}"/>
                        <input type="hidden" name="toolNo" id="toolNo" value="${tool.toolNo}"/>
                    </td>
                    <td>工具名称</td>
                    <td>
                        <input type="text" name="toolName" id="toolName" value="${tool.toolName}"/>
                    </td>
                </tr>
                <tr>
                    <td>单位</td>
                    <td>
                        <select name="unit" id="unit">
                            <option value="">请选择</option>
                            <nt:code index="${tool.unit}" ctype="003"></nt:code>
                        </select>
                    </td>
                    <td>库存</td>
                    <td>
                        <input type="text" name="stock" id="stock" value="${tool.stock}"/>
                    </td>
                </tr>
                <tr>
                    <td>备注</td>
                    <td colspan="3"><textarea cols="10" name="remark">${tool.remark}</textarea> </td>
                </tr>
                <tr>
                    <td>录入人</td>
                    <td>${tool.applyOpr}</td>
                    <td>录入日期</td>
                    <td><fmt:formatDate value="${tool.applyDate}" pattern="yyyy-MM-dd" ></fmt:formatDate></td>
                </tr>
            </table>
        </form>
    </div>
