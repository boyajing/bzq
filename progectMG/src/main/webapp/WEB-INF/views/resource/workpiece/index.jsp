...
<head>
    ...
    <script type="text/javascript">
        ...
        function detailC(id) {
            window.open("<%=path%>/workpiece/updateWorkpiece?workpieceNo="+id+"&edit=2", "frame", "height=600,width=1000,top=100,left=300,toolbar=no,menubar=no,scrollbars=no, resizable=1,location=no, status=no");
        }
        function chooseWP() {
            var temp = $("input[name='checkboxs']:checked");
