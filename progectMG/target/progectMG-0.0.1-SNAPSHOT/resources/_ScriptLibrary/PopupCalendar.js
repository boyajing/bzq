...
function CalendarInit()				///Create panel
{
	...
	htmloButton+=" onclick=clickCalendarCancel("+this.instanceName+")>"+this.oBtnCancelTitle+"</button> "
	htmloButton+="</div>"
	/// All
...
function clickCalendarCancel(oInstance){
	var CalendarDiv=document.all[oInstance.sDIVID];
	CalendarDiv.style.display="none";		
	if(oInstance.oTaget.tagName.toLowerCase()=="input")oInstance.oTaget.value = "";
}