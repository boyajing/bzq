...
//                alert(taskid+"--"+ userid);
            $.ajax({
                url: "<%=cpath%>/flowMG/transferAssign/"+taskid + "/"+ userid +".json",
                type: "POST",
                async: true,
                data: {},
        ...
        function save() {
            ...
            $.ajax({
                url:'<%=cpath%>/flowMG/ProcessJump.json',
                data:{

                    taskid: $("#taskid").val(),
                    activitid:$("#activitid").val(),
                    commit:$("#commit").val()
                },
                dataType:'json',
                type:'post',
...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <button type="button" id="save" onclick="save();">提交</button>
    ...
    <div align="center"><h4>流程跳转</h4></div>
    <div>
    <form id="expendForm" method="post">
        <div>
            <table id="atable">
                ...
                <tr>
                    <td>环节ID</td>
                    <td><input type="text" id="taskid"  name="taskid" value="${taskid}"/></td>
                    <td>流程ID</td>
                    <td><input type="text"  id="activitid" name="activitid" value="${activitid}"/></td>
                </tr>
                <tr>
                    <td>备注</td>
                    <td><input type="text" id="commit"  name="commit" value="${commit}"/></td>
                    <td></td>
                    <td></td>
                </tr>
            </table>
    ...
    <div class="row-fluid">
                    <span class="span12" style="margin-top:10px">
                            ...
                            <div align="center"><h4>待办任务</h4></div>
                        <table  class="well table table-striped table-hover">
                            <thead>
                                <tr style="background-color:#ffffff">
                                    ...
                                    <th inorder="true" insel="true" column="USER_ID">
                                        <span class="tableheadOrder">当前环节ID</span>
                                    </th>
