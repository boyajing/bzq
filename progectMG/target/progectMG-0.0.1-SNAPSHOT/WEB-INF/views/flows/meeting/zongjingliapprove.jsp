...
<script type="text/javascript">
    ...
    function reback() {
        ...
        $.ajax({
            type: 'POST',
            url: '<%=path%>/flow/takeBack/'+flowid+'/'+taskId+'/zongjingli/dongshizhang.json',
            dataType: 'json',
            async: false,
            data :{},
            success: function (data) {
        ...
        <table id="votetable">
            ...
            <c:forEach var="item" items="${biaojuelist}" varStatus="status">
                <tr>
                    ...
                    <td>
                        <textarea  type="text" name="zongjingliOpinion_${item.issueId}"  cols ="300" rows="10" maxlength="999" onscroll= "this.rows=this.rows+1"
