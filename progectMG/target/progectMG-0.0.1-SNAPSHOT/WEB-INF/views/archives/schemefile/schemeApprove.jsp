...
<script type="text/javascript">
    ...
    function queryAll(temp) {
       <%--location.href="<%=path%>/programme/queryAll?flowName=planparallelflow&schemeId="+temp;--%>
        <%--window.open("<%=path%>/fileManager/index_view?businessType=file_2&businessId="+temp+"&projectCode="+temp1, "方案档案管理", "height=800,width=1500,top=100,left=300,toolbar=no,menubar=no,scrollbars=yes, resizable=1,location=no, status=no");--%>
        window.open('<%=path%>/programme/queryAll?flowName=planparallelflow&schemeId='+temp+' ');
    }
</script>